...
urlpatterns = [
    ...
    path('api/content/', include('sova_school.content.urls')),
    path('api/global_content/', include('sova_school.global_content.urls')),
    path('api/users/', include('sova_school.users.urls')),
]
